...
ALTER TABLE categories_attributes ADD FOREIGN KEY (categories_id) REFERENCES categories (id);

ALTER TABLE categories_attributes ADD FOREIGN KEY (attributes_id) REFERENCES attributes (id);
...
ALTER TABLE products_attribute_value ADD FOREIGN KEY (products_id) REFERENCES products (id);

ALTER TABLE products_attribute_value ADD FOREIGN KEY (attribute_value_id) REFERENCES attribute_value (id);


ALTER TABLE attribute_value ADD FOREIGN KEY (attribute_id) REFERENCES attributes (id);
